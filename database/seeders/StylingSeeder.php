    ...
    public function run()
    {
        ...
        foreach ($template_name_arr as $key=>$template_name_css_path) {
            ...
            $variable_html = '
            {
                ...
                "gallery_photo_htmlarr":  "<div class=\"row gall_row\"><div class=\"col-md-3 pic_gal_img\"> <img src=\"{!!{gallery_photo_arr.image_show_var}!!}\"   alt=\"\"></div> <div class=\"col-md-3 pic_gal_img\"> <img src=\"{!!{gallery_photo_arr.image_show_var}!!}\" alt=\"\"> </div> <div class=\"col-md-3 pic_gal_img\"> <img src=\"{!!{gallery_photo_arr.image_show_var}!!}\" alt=\"\"> </div> </div>",
                "gallery_video_htmlarr":  "<div class=\"row vid_row\"><div class=\"col-md-3 pic_gal_img\"><img src=\"{!!{gallery_video_arr.image_show_var}!!}\"  alt=\"\"></div><div class=\"col-md-3 pic_gal_img\"><img src=\"{!!{gallery_video_arr.image_show_var}!!}\"  alt=\"\"></div><div class=\"col-md-3 pic_gal_img\"> <img src=\"{!!{gallery_video_arr.image_show_var}!!}\" alt=\"\"> </div></div>",
                "gallery_audio_htmlarr":  "<div class=\"uploaded_audio_area\"><div class=\"uploaded_audio_box\"><p>{!!{gallery_audio_arr.date_show_var}!!} .by {!!{gallery_audio_arr.name_show_var}!!}</p><audio controls autoplay><source src=\"{!!{gallery_audio_arr.image_show_var}!!}\" type=\"audio/mpeg\" /></audio></div><div class=\"uploaded_audio_box\"><p>{!!{gallery_audio_arr.date_show_var}!!} .by {!!{gallery_audio_arr.name_show_var}!!}</p><audio controls autoplay><source src=\"{!!{gallery_audio_arr.image_show_var}!!}\" type=\"audio/mpeg\" /></audio></div></div>",


                "gallery_photo_tab_htmlvar":"<div id=\"photo\" class=\"tab_galcontent\"> <div class=\"gall_top_bttn\"> <div class=\"flx\">  <div class=\"slidsho_txt\" > <label for=\"file_upload\" class=\"custom-file-upload\">  Add a Photo </label><input type=\"file\"  accept=\"image/*\" id=\"file_upload\" name=\"upld_file\" class=\"upld_file crop_upload_image\" image_width=\"378\" image_height=\"226\" aspect_ratio_width=\"16\" aspect_ratio_height=\"9\" upload_input_by_name=\"upld_file_hid\" ></div><div class=\"publish_btn\"><button id =\"save_media_image\"class=\"btn btn-danger\">Publish</button></div> </div> </div> <div class=\"gallery_img\"> {!!{gallery_photo_htmlarr}!!}</div></div>",
                "gallery_audio_tab_htmlvar":"<div id=\"Audio\" class=\"tab_galcontent\"><div class=\"audio_icon\">{!!{gallery_audio_htmlarr}!!}<i class=\"fa fa-microphone\" aria-hidden=\"true\"></i></div><div class=\"add_audio\"> <div class=\"aud_head\"> Add Audio </div><div class=\"aud_box\"><label for=\"audio_upload\" class=\"custom-file-upload\"> <i class=\"fa fa-cloud-upload\" aria-hidden=\"true\"></i></label> <input type=\"file\" accept=\"audio/*\" id=\"file_upload\" id=\"audio_upload\" name=\"upld_aud\" class=\"upld_audio\" > <p>From Your Device</p> </div><div class=\"publishing_btn aud\"><button id =\"save_media_audio\"class=\"btn btn-danger\">Publish</button></div></div></div>",
                "gallery_video_tab_htmlvar":"<div id=\"video\" class=\"tab_galcontent\"> <div class=\"gall_top_bttn\"> <div class=\"flx\">  <div class=\"slidsho_txt\" > <label for=\"file_upload\" class=\"custom-file-upload\">  Add a Video </label><input type=\"file\"  accept=\"video/*\" id=\"file_upload\"  id=\"vid_upload\" name=\"upld_vid\" class=\"upld_video\" ></div> <div class=\"publish_btn\"><button id =\"save_media_video\"class=\"btn btn-danger\">Publish</button></div></div> </div><div class=\"gallery_video\">{!!{gallery_video_htmlarr}!!} </div></div>",
