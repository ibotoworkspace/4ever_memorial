    ...
    public function run()
    {
            ...
            <div class="container">
                  ...
                  <div class="tab_area">
                    ...
                    <div id="About" class="tabcontent">
                       ...
                       <p><ul class="li_txt">
                          ...
                          <p class="abt_txt">This memorial website was created in memory of our beloved son, Anthony Bouslaiby, 18 years old, born on September 1, 2004, and passed away on December 11, 2022. He will be with us forever, and we will never stop loving him. I decided to start this website to celebrate his life. Even though he wasn't with us as long as he should've been, he has touched so many lives and was so loved. I hope you all will contribute to this page, with picture, videos, and stories. I was so touched by all the memories left in the memory jar at the luncheon. Please feel free to add more, as they may come to you, because that's all we have left once a  loved one leaves us. We all appreciate the love you showed Anthony for however long you may have known him. Thank you all!
                          <br>
                          Angela (his mom)
                          <br>
                          P.S. Please let me know if you have any probelms uploading etc. You can click on a photo to see the caption.</p>
                              <div class="tributes">
                                  <h1>Tributes</h1>
                                  <button class="bt_trei"><i class="fa fa-pencil" aria-hidden="true"></i>_ Leave a Tribute</button>
                                </div>
                                    ...
                                    <div class="reviewBox">
                                      ...
                                      <ul class="reviewSection">
                                          ...
                                          <li>
                                              <h3>Maria Nashed</h3>
                                              <h5>January 23</h5>
                                              <p>Anthony was an amazingly sweet friend. After class he would always walk me to my car and then I would drive him to his. We would always have a good time laughing at the way we pronounced Arabic words due to difference in dialect even though he knew little-to-no Arabic at all lol. I also remember how whenever I would ask for help on homework, he would always insist on teaching me how to do the problems fully in order for me to better... <a href="#">read more</a></p>
                                          </li>
                                      </ul>
                                  </div>
                                  <div class="reviewBox">
                                      ...
                                      <ul class="reviewSection">
                                          ...
                                          <li>
                                              ...
                                              <h5>January 22</h5>
                                              <p>I remember one day after my bone marrow transplant. I was staying at my daughters house while recovering. I think my daughter had to go out and all of a sudden Anthony came to my room and pulled up a chair. No doubt he was told to make sure I didn't get out of bed. Anyway we started talking and I asked him about school and what he was learning. I think it was some scientific thing that he started explaining to me. I was in awe of the way he.... <a href="#">read more</a></p>
                                          </li>
                                      </ul>
                                  </div>
                                  <div class="reviewBox">
                                      ...
                                      <ul class="reviewSection">
                                          ...
                                          <li>
                                              ...
                                              <h5>January 21</h5>
                                              <p>Anthony was such a kind person he never made me feel left out nor ever judged me</a></p>
                                          </li>
                                      </ul>
                                  </div>
                                  <div class="reviewBox">
              ...
              <div class="col-md-4">
                  <div class="rightBoxArea familyFriend">
                      <ul>
                          <li><h3>Invite Anthony's family and friends</h3></li>
                          <li><i class="fa fa-user-plus" aria-hidden="true"></i></li>
                      </ul>
                      <a href="#" class="btn btn-primary btnInvite"><i class="fa fa-user-plus" aria-hidden="true"></i> Invite Now</a>
                  </div>
      ...
      `;
        ...
        <ul>
            ...
            "user_memorial_tribute":"<h3 class=\"about_heading\">Let the memory of Anthony be with us forever.</h3>
            <p>
            <ul class=\"li_txt\">
                <li>18 years old</li>
                <li>Born on September 1, 2004 in San Dimas, California, United States</li>
            ...
            "tributes":[{
                "user_id":1,
                "image_show":"`+$image_path+`/user_templates/template_1/images/flower.png",
            ...
            {
                "user_id":1,
                "image_show":"`+$image_path+`/user_templates/template_1/images/candel.png",
