...
<html>
            ...
            <head>
                ...
                <link rel="stylesheet" href="{!! asset('public/user_templates/template_4/css/style.css') !!}" />
    ...
    $(document).ready(function() {
        ...
        function prof_img(recent_arr) {
            ...
            var images_html = '';
                ...
                images_html = images_html + `<img src="{!!$base_url!!}/public/theme/user_theme/images/profile.png" alt="relative" />`;
