<html>
  <head>
    ...
    ></script>
    <link rel="stylesheet" href="{!!asset('user_templates/template_2/css/style.css')!!}" />
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="profile_img">
            <img src="{!!asset('user_templates/template_2/images/prof_tem_2.jpg')!!}" class="img-fluid responsive" alt="relative" />
          </div>
        </div>
      </div>
    </div>
