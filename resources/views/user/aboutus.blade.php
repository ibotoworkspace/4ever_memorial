...
<head>
    <title>4Year Project About-US</title>
    <meta charset="utf-8">
        ...
        <div class="aboutarea">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <div class="aboutimg">
                            <img src="{!!asset('images/jacob.png')!!}" class="img-responsive">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="aboutareaa">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="aboutimg">
                            <img src="{!!asset('images/mission.jpg')!!}" class="img-responsive">
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="aboutimg">
                            <img src="{!!asset('images/vision.jpg')!!}" class="img-responsive">
                        </div>
                    </div>
                </div>
            </div>
