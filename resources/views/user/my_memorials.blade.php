                                    ...
                                    <div class="col-sm-12 outer-bx">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="img-bx">
                                                    <div class="col-md-6 align">
                                                        ...
                                                        <div class="bx_bg">
                                                            <img src="{!! asset('theme/images/4-evercc.png') !!}" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="line"></div>
                                                    <div class="col-md-6">
                                                        {{-- {!!dd($m)!!} --}}
                                                        <p><b>Name: </b> {!! ucwords($m->f_name) !!} <span class="sidetick"><i
                                                                    class="fa fa-envelope" aria-hidden="true"></i></span>
                                                        </p>
                                                        <p><b> Born: </b>{!! ucwords($m->b_year) !!} <span class="sidetick"><i
                                                                    class="fa fa-calendar" aria-hidden="true"></i></span>
                                                        </p>
                                                        <p><b>Death: </b> {!! ucwords($m->p_year) !!} <span class="sidetick"><i
                                        ...
                                        <div class="col-sm-6">
                                            <div class="plandatas">
                                                ...
                                                <p><b>Email: </b> {!! ucwords($m->email) !!} <span class="sidetick"><i
                                                            class="fa fa-envelope" aria-hidden="true"></i></span></p>
                                                <p><b> Born: </b>{!! ucwords($m->b_year) !!} <span class="sidetick"><i
                                                            class="fa fa-calendar" aria-hidden="true"></i></span></p>
                                                <p><b>Death: </b> {!! ucwords($m->p_year) !!} <span class="sidetick"><i
                                                            class="fa fa-calendar-o" aria-hidden="true"></i></span></p>
                                                <div class="inerpkgclick">
                                                    <a href="{!! asset('user/get_memorial/' . $m->email) !!}">
                                                        <input type="button" class="btn btn-primary banclick"
                                                            value="Open">
